...
export const MODEL_OR_STAGES_REQUIRED = 'model or stages is required';
export const MODEL_STAGES_CONFLICT = 'Provide either model or stages, not both.';
...
export const MODEL_SPEC_CONTENT_REQUIRED = 'model must include bone, cube, or rigTemplate';
export const MODEL_SPEC_ANCHORS_ARRAY = 'anchors must be an array';
export const MODEL_SPEC_BONE_OBJECT = 'bone must be an object';
export const MODEL_SPEC_CUBE_OBJECT = 'cube must be an object';
...
export const MODEL_DUPLICATE_ROOT_FIX =
  'Remove the duplicate "root" bone. When enforceRoot is enabled, a root bone is auto-created if missing.';
...
export const MODEL_CUBE_PARENT_REQUIRED = 'cube parentId is required';
export const MODEL_CUBE_PARENT_REQUIRED_FIX = 'Provide cube.parentId or set model.policies.defaultParentId.';
