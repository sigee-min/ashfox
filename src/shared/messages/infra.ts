...
export const SERVER_HTTP_PERMISSION_MESSAGE = 'greyfox needs HTTP access for the local MCP server.';
export const SERVER_NET_PERMISSION_MESSAGE = 'greyfox needs network permission to accept MCP connections.';
export const SERVER_NET_PERMISSION_DETAIL = 'greyfox opens a local server so AI assistants can connect.';
export const SERVER_NO_TRANSPORT = 'http/net modules not available; MCP server not started';
export const SIDECAR_PERMISSION_MESSAGE = 'greyfox needs permission to run a local MCP sidecar process.';
...
export const SIDECAR_ENTRY_NOT_FOUND = 'sidecar entry not found; expected greyfox-sidecar.js near plugin';
...
export const TMP_STORE_PERMISSION_MESSAGE = 'greyfox needs filesystem access to store image snapshots.';
...
export const ADAPTER_GLTF_WRITE_UNAVAILABLE = 'glTF writer unavailable';
