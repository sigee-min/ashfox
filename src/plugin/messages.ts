...
export const PLUGIN_UI_EXPORT_FAILED_PREFIX = 'greyfox export failed: ';
export const PLUGIN_UI_EXPORT_COMPLETE = 'greyfox export complete';
export const PLUGIN_UI_EXPORT_FAILED_GENERIC = 'export failed';
export const PLUGIN_UI_LOADED = (version: string) => `greyfox v${version} loaded`;
export const PLUGIN_UI_UNLOADED = 'greyfox unloaded';
