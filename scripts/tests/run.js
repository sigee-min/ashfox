...
const tests = [
  ...
  'modelPipelineRevisionGuard.test.ts',
  'proxyRouterHandle.test.ts',
  'textureSpecProxy.test.ts',
  'uvSpecProxy.test.ts',
  'session.test.ts',
  ...
  'entityPipeline.test.ts',
  'proxyTexture.test.ts',
  'texturePipelineSteps.test.ts',
  'texturePlanConflicts.test.ts',
  ...
  'textureIntegrationMock.test.ts',
